    <div class="blog-post row contextual-links-region">
        ...
        <div class="entry col-sm-10">
            ...
            <?php if($blog_entry['has_picture']) : ?>
                <img src="<?php print $blog_entry['picture']['url']?>" alt="Placeholder" width="154" height="100" class="right thumbnail teaser-img-small">
            <?php elseif($blog_entry['has_video']) :  ?>
                <div class="right thumbnail col-sm-4 teaser-img-small"><?php print $blog_entry['video']['content'];?></div>
...
<!--            <img src="img/birdgreen-lg.jpg" alt="Placeholder" width="154" height="100" class="right thumbnail">-->
            <?php
