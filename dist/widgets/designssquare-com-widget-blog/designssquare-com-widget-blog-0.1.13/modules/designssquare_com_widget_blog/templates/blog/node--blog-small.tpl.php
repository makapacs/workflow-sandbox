<div class="row contextual-links-region" style="margin-bottom:50px;">
    ...
    <div class="span8">
        <div class="row">
            <div class="span8 blog_item" style="margin-bottom:0px;">
                <!--Post info and Title-->
                <div class="blog_head">
    ...
    <?php if($blog_entry['has_picture']) : ?>
        <!--Post with Image-->
                <div class="view view-first blog-small">
                    <?php print ' <img src="'.$blog_entry['picture']['url'].'" alt="" />';?>
